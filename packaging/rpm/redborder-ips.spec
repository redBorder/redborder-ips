...
Requires: bash ntp dialog dmidecode rsync nc telnet redborder-common redborder-chef-client redborder-rubyrvm redborder-cli rb-register bridge-utils "kernel-devel-uname-r == $(uname -r)" pfring-dkms net-tools bind-utils
